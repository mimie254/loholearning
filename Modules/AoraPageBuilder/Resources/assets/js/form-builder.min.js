...
! function(A) {
    ...
    112: function(A, t, e) {
        ...
        function u(A, t, e, r) {
            var o = e ? "" : r.css;
            if (A.styleSheet) A.styleSheet.cssText = b(t, o);
            else {
        ...
        function f(A, t, e) {
            ...
            (t.convertToAbsoluteUrls || n) && (r = y(r)), o && (r += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(o)))) + " */");
            var i = new Blob([r], {
                    type: "text/css"
                }),
                s = A.href;
            ...
            y = function() {
                ...
                return A.prototype.startMoving = function(A, t) {
                    ...
                    return e = [{
                        ...
                        events: {
                            click: function(A) {
                                t.save(), d.config.opts.onSave(A, t.data.formData)
                            }
                        }
    ...
    147: function(A, t, e) {
        ...
        var M = e(34),
            ...
            Q = function A(t, e) {
                ...
                b.default.controlConfig = t.controlConfig || {};
                var C = new w.default(B, Q),
                    D = g.default.markup,
                    v = t;
                b.default.loadCustom(t.controls), Object.keys(t.fields).length && I.default.register(t.templates, t.fields), t = C.processOptions(t);
                var x = E.config.subtypes = C.processSubtypes(t.subtypes);
                C.editorUI(B);
                var Y = $(M.stage);
                y.layout = C.editorLayout(t.controlPosition), y.formID = B, y.lastID = y.formID + "-fld-1";
                var N = b.default.getRegistered(),
                ...
                for (var F = $(M.controls), T = [], R = {}, L = 0; L < N.length; L++) {
                    var U = N[L],
                        ...
                        S = void 0;
                    if (G) S = G.class;
                    else if (G = {}, !(S = b.default.getClass(U)) || !S.active(U)) continue;
                ...
                M.editorWrap = D("div", null, {
                    id: y.formID + "-form-wrap",
                    className: "form-wrap form-builder" + g.default.mobileClass()
                });
                var H = $(M.editorWrap),
                    V = D("div", M.controls, {
                        id: y.formID + "-cb-wrap",
                        className: "cb-wrap " + y.layout.controls
                    });
                ...
                var K = D("div", [M.stage, V], {
                    id: y.formID + "-stage-wrap",
                    className: "stage-wrap " + y.layout.stage
                });
                ...
                var _ = function() {
                        ...
                        if (A instanceof jQuery)
                            if (e.type = A[0].dataset.type, e.type) {
                                ...
                                if (r) e = Object.assign({}, r);
                                    ...
                                    var o = b.default.getClass(e.type);
                    ...
                    uA = function(A) {
                        ...
                        }).outerHTML, a += '<div id="' + y.lastID + '-holder" class="frm-holder">', a += '<div class="form-elements">', a += oA(A), a += D("a", p.close, {
                        ...
                        }), C.updatePreview(f), t.typeUserEvents[r] && t.typeUserEvents[r].onadd && t.typeUserEvents[r].onadd(u), t.editOnAdd && e && (C.closeAllEdit(), C.toggleEdit(y.lastID, !1)), y.lastID = C.incrementId(y.lastID)
                    },
                    gA = function(A, t, e) {
                        var r = {
                    ...
                    fA = function(A) {
                        ...
                        return $(".fld-name", i).val(n), i.find("[id]").each(function(A, t) {
                            t.id = t.id.replace(e, y.lastID)
                        }), i.find("[for]").each(function(A, t) {
                            var r = t.getAttribute("for"),
                                o = r.replace(e, y.lastID);
                            t.setAttribute("for", o)
                        }), i.attr("id", y.lastID), i.attr("name", n), i.addClass("cloned"), $(".sortable-options", i).sortable(), t.typeUserEvents[r] && t.typeUserEvents[r].onclone && t.typeUserEvents[r].onclone(i[0]), y.lastID = C.incrementId(y.lastID), i
                    };
                ...
                return document.dispatchEvent(d.default.loaded), f.actions = {
                    ...
                    addField: function(A, t) {
                        C.stopIndex = y.formData.length ? t : void 0, AA(A), document.dispatchEvent(d.default.fieldAdded)
                    },
        ...
        window.fbLoaded = {
            ...
            Array.isArray(A) || (A = [A]), A.forEach(function(A) {
                var e = "href",
                    n = A,
                    i = "";
                if ("object" == (void 0 === A ? "undefined" : r(A)) && (e = A.type || (A.style ? "inline" : "href"), i = A.id, A = "inline" == e ? A.style : A.href, n = i || A.href || A.style), !o.isCached(n, "css")) {
                    if ("href" == e) {
                        var s = document.createElement("link");
                        s.type = "text/css", s.rel = "stylesheet", s.href = (t || "") + A, document.head.appendChild(s)
                    } else $('<style type="text/css">' + A + "</style>").attr("id", i).appendTo($(document.head));
    ...
    60: function(A, t, e) {
        (function(t, e) {
            ! function(t) {
                ...
                if (b) return void(y && (A.exports = b));
                b = t.regeneratorRuntime = y ? A.exports : {}, b.wrap = r;
                ...
                i.prototype = D.constructor = s, s.constructor = i, i.displayName = "GeneratorFunction", b.isGeneratorFunction = function(A) {
                    ...
                    return new l(A)
                }, a(c.prototype), b.async = function(A, t, e, o) {
                    var n = new c(r(A, t, e, o));
                    return b.isGeneratorFunction(t) ? n : n.next().then(function(A) {
            ...
            c = function(A) {
                ...
                return i(t, A), t.prototype.build = function() {
                    var A = this,
                        ...
                        n = r(t, ["values", "type"]),
                        i = function(t) {
                            var e = t.target.nextSibling.nextSibling,
                                r = t.target.nextSibling,
                                o = A.getActiveOption(e),
                                n = new Map([
                                    [38, function() {
                                        var t = A.getPreviousOption(o);
                                        t && A.selectOption(e, t)
                                    }],
                                    [40, function() {
                                        var t = A.getNextOption(o);
                                        t && A.selectOption(e, t)
                                    }],
                                    [13, function() {
                                        o && (t.target.value = o.innerHTML, r.value = o.getAttribute("value"), "none" === e.style.display ? A.showList(e, o) : A.hideList(e)), t.preventDefault()
                                    }],
                                    [27, function() {
                                        A.hideList(e)
                                    }]
                        ...
                        s = Object.assign({}, n, {
                            ...
                            events: {
                                focus: function(t) {
                                    var e = t.target.nextSibling.nextSibling,
                                        r = (0, l.filter)(e.querySelectorAll("li"), t.target.value);
                                    if (t.target.addEventListener("keydown", i), 0 < t.target.value.length) {
                                ...
                                input: function(t) {
                                    ...
                                    var r = (0, l.filter)(e.querySelectorAll("li"), t.target.value);
                                    if (0 == r.length) A.hideList(e);
                                    else {
                                        var o = A.getActiveOption(e);
                                        o || (o = r[r.length - 1]), A.showList(e, o)
                                    }
                                }
                            }
                        }),
                                ...
                                r = {
                                    events: {
                                        click: function(e) {
                                            ...
                                            o.value = t.label, o.nextSibling.value = t.value, A.hideList(r)
                                        }
                                    },
                                    value: t.value
                                };
                ...
                }, t.prototype.hideList = function(A) {
                    this.selectOption(A, null), A.style.display = "none"
                }, t.prototype.showList = function(A, t) {
                    this.selectOption(A, t), A.style.display = "block", A.style.width = A.parentElement.offsetWidth + "px"
                }, t.prototype.getActiveOption = function(A) {
                    var t = A.getElementsByClassName("active-option")[0];
                    return t && "none" !== t.style.display ? t : null
                }, t.prototype.getPreviousOption = function(A) {
                    var t = A;
                    do {
                        t = t ? t.previousSibling : null
                    } while (null != t && "none" === t.style.display);
                    return t
                }, t.prototype.getNextOption = function(A) {
                    var t = A;
                    do {
                        t = t ? t.nextSibling : null
                    } while (null != t && "none" === t.style.display);
                    return t
                }, t.prototype.selectOption = function(A, t) {
        ...
        var i = function() {
            ...
            l = function(A) {
                ...
                return n(t, A), t.prototype.configure = function() {
                    ...
                    }], this.handler = this.classConfig.handler || "/upload", ["js", "css", "handler"].forEach(function(t) {
                        ...
                        e = $.extend(!0, {
                            ...
                            callbacks: {
                                onError: function(t, e, r) {
                                    "." != r.slice(-1) && (r += ".");
                                    var o = $("<div />").addClass("qq-error-message").html("<span>Error processing upload: <b>" + e + "</b>.<br />Reason: " + r + "</span>").prependTo(A.find(".qq-uploader"));
                                    setTimeout(function() {
                                        o.fadeOut(function() {
                                            o.remove()
                                        })
                                ...
                                onStatusChange: function() {
                                    for (var e = A.fineUploader("getUploads"), r = [], o = e, n = Array.isArray(o), i = 0, o = n ? o : o[Symbol.iterator]();;) {
                                        var s;
                                        if (n) {
                                            if (i >= o.length) break;
                                            s = o[i++]
                                        ...
                                        var a = s;
                                        "upload successful" == a.status && r.push(a.name)
                                    }
                                    t.val(r.join(", "))
                                }
                            },
                    ...
                    if ((u.multiple || "checkbox-group" === s) && (u.name += "[]"), "checkbox-group" === s && u.required && (this.onRender = this.groupRequired), delete u.title, o) {
                        ...
                        for (var d, p = 0; p < o.length; p++) {
                            ...
                            if (E.id = u.id + "-" + p, (!E.selected || i) && delete E.selected, void 0 !== n && E.value === n && (E.selected = !0), f) {
                                var y = this.markup("option", document.createTextNode(w), E);
                                t.push(y)
                            } else {
                                var b = g;
                                a && (b += "-inline"), E.type = g, E.selected && (E.checked = "checked", delete E.selected);
